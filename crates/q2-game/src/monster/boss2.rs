//! Boss2 (Hornet) monster. C ref: ~/Qwasm2/src/game/monster/boss2/
use q2_shared::types::*;
use crate::ai;
use crate::constants::*;
...
pub fn sp_monster_boss2(storage: &mut EntityStorage, key: EntityKey, fields: &HashMap<String, String>) {
    if let Some(ent) = storage.get_mut(key) {
        ent.game.classname = fields.get("classname").cloned().unwrap_or_else(|| "monster_boss2".to_string());
